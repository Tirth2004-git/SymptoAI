...
if __name__ == "__main__":
    # Train all models to ensure they are compatible with the current scikit-learn version
    models = ['decision_tree', 'random_forest', 'mnb', 'gradient_boost']
    for model_name in models:
        ...
        test_accuracy, test_clf_report = dp.make_prediction(saved_model_name=model_name)
        print(f"{model_name} Model Test Accuracy: ", test_accuracy)